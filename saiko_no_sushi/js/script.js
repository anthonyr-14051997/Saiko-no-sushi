...
const sjt = document.querySelector('#subject');
...
function send() {
    ...
    let sjtval = sjt.value;
    let msgval = msg.value;

	ajaxC( nomval , mailval , msgval, sjtval ); //Envoie du formulaire

	return true;
}

function ajaxC(nom,mail,msg, sjt){
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "./php/mail.php?submit=true&name=" + nom + "&email=" + mail + "&subject" +  + "&message=" + msg);
